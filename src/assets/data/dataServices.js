    ...
    services: [
      {
        ...
        description:
          "Un accompagnement pensé pour les sportifs particulaires et les clubs",
        items: [
      ...
      },
      {
        ...
        items: [
          { name: "Boxe femmes", price: "1 h · 50 €" },
          { name: "Boxe enfants", price: "1 h · 40 €" },
        ],
        cta: "Prendre rendez-vous",
      },
    ],
    ...
    services: [
      {
        ...
        items: [
          { name: "Remodelage corporel", price: "1 h · 100 €" },
          {
          ...
          { name: "Shiatsu myo-énergétique", price: "Tarif à préciser" },
        ],
        cta: "Prendre rendez-vous",
      },
    ],
  ...
  equilibre: {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Un accompagnement pour relâcher progressivement les tensions",
        price: "1 h · 90 €",
        cta: "Prendre rendez-vous",
      },
    ],
    ...
    services: [
      {
        ...
        items: [
          { name: "Remodelage facial", price: "1 h · 130 €" },
          { name: "Relâchement myofascial du visage", price: "Tarif à préciser" },
        ],
        cta: "Prendre rendez-vous",
      },
    ],
