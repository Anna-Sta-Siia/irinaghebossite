...
11. Оплата	Stripe: acompte/garantie по решению Ирины; данные банковских карт мы не храним	
12. Email	подтверждение записи, изменение/отмена, сообщения Ирине	
13. Юридическое	mentions légales, confidentialité/RGPD, CGV/annulation, consentement	
14. Production	домен, профессиональный email, Vercel, БД, environment variables	
15. Проверка	mobile/tablet/desktop, формы, ошибки, 404, accessibility, SEO/performance	